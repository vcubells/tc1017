...
int main()
{
    ...
    int eleccion;  /* elecciÛn del usuario */
    ...
    if ( ( ptrCf = fopen( "/Users/vcubells/Desktop/credito.dat", "rb+" ) ) == NULL ) {
        ...
        /* permite al usuario especificar una acciÛn */
        while ( ( eleccion = intOpcion() ) != 5 ) {
            ...
            switch ( eleccion ) {
                ...
                case 4:
                    ...
                    /* si el usuario no selecciona una opciÛn v·lida, despliega un mensaje */
                default:
...
/* crea un archivo de texto con formato para impresiÛn */
void archivoTexto( FILE *ptrLee )
{
    ...
    /* fopen abre el archivo; si no se puede abrir, sale del archivo */
    if ( ( ptrEscribe = fopen( "/Users/vcubells/Desktop/cuentas2.txt", "w" ) ) == NULL ) {
...
} /* fin de la funciÛn archivoTexto */

/* actualiza el saldo en el registro */
void actualizaRegistro( FILE *ptrF )
{
    int cuenta;         /* n˙mero de cuenta */
    double transaccion; /* monto de la transacciÛn */
    
    /* crea datosCliente sin informaciÛn  */
    struct datosCliente cliente = { 0, "", "", 0.0 };
    
    /* obtiene el n˙mero de cuenta para actualizaciÛn */
    ...
    if ( cliente.numCta == 0 ) {
        ...
        /* pide al usuario el monto de la transacciÛn */
...
} /* fin de la funciÛn actualizaRegistro */

/* elimina el registro existente */
void eliminaRegistro( FILE *ptrF )
{
    
    struct datosCliente cliente; /* almacena los registros leÌdos en el archivo */
...
} /* fin de la funciÛn eliminaRegistro */
...
} /* fin de la funciÛn nuevoRegistro */

/* inhabilita al usuario para introducir una opciÛn de men˙ */
int intOpcion( void )
{
    int opcionMenu; /* variable para almacenar la opciÛn del usuario */
    ...
    scanf( "%d", &opcionMenu ); /* recibe la opciÛn del usuario */
    
    return opcionMenu;
    
} /* fin de la funciÛn introduceOpcion */
